  ...
  bio.display(); // DISPLAYING ALL BIO ON PAGE
    ...
    var education = {
        ...
        "display": function() {
            ...
            // Displays schools and education

            $.each(education.schools, function(edu) {

                $('#education').append(HTMLschoolStart); //Appends schoola nd education to the #education header
    ...
    var work = {
        ...
        "display": function() {
            ...
            $.each(work.jobs, function(j) {
                ...
                $('#workExperience').append(HTMLworkStart); //Appends work experience to #workExperience header
   ...
   work.display(); //Displays work history
